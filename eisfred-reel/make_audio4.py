...
def gain_for(name):
    g = np.zeros(n)
    for a,b in {"F":[(0,5.5),(9,12.1)], "Bb":[(5.5,9)]}[name]:
...
add(noi*(tt/L)**2.1, 6.4, 0.06)

# shimmer under the brand card
for f0, at in [(698.46, 9.1), (880.0, 9.35), (1046.5, 9.6)]:
