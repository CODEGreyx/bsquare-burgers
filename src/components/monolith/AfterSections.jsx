...
const MATERIALS = [
  {
    n: '01',
    name: 'RAW CONCRETE',
    note: 'Board-formed in place. Left honest.',
    src: FRAMES[3].src,
    pos: '52% 68%',
  },
  {
    n: '02',
    name: 'NATURAL STONE',
    note: 'Field stone from the site itself.',
    src: FRAMES[5].src,
    pos: '58% 62%',
  },
  {
    n: '03',
    name: 'GLASS',
    note: 'Floor to ceiling. Frameless corners.',
    src: FRAMES[7].src,
    pos: '38% 62%',
  },
  {
    n: '04',
    name: 'WATER',
    note: 'A still line between house and sea.',
    src: FRAMES[6].src,
    pos: '50% 82%',
  },
]
